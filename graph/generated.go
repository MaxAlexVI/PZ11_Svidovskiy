...
func (ec *executionContext) field_Mutation_createTask_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "input", ec.unmarshalNCreateTaskInput2exampleᚗcomᚋpz11ᚑgraphqlᚋgraphᚋmodelᚐCreateTaskInput)
	if err != nil {
		return nil, err
	}
	args["input"] = arg0
...
func (ec *executionContext) field_Mutation_updateTask_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	...
	args["id"] = arg0
	arg1, err := graphql.ProcessArgField(ctx, rawArgs, "input", ec.unmarshalNUpdateTaskInput2exampleᚗcomᚋpz11ᚑgraphqlᚋgraphᚋmodelᚐUpdateTaskInput)
	if err != nil {
		return nil, err
	}
	args["input"] = arg1
...
func (ec *executionContext) unmarshalNCreateTaskInput2exampleᚗcomᚋpz11ᚑgraphqlᚋgraphᚋmodelᚐCreateTaskInput(ctx context.Context, v any) (model.CreateTaskInput, error) {
...
func (ec *executionContext) unmarshalNUpdateTaskInput2exampleᚗcomᚋpz11ᚑgraphqlᚋgraphᚋmodelᚐUpdateTaskInput(ctx context.Context, v any) (model.UpdateTaskInput, error) {
